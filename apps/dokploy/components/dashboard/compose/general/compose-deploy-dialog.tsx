...
export const ComposeDeployDialog = ({ onDeploy, isLoading, children }: Props) => {
	...
	return (
		<AlertDialog open={open} onOpenChange={setOpen}>
			...
			<AlertDialogContent>
				<AlertDialogHeader>
					<AlertDialogTitle>Deploy Compose</AlertDialogTitle>
					<AlertDialogDescription>
						Deploy the compose. Optionally specify a commit hash to deploy a
						specific version.
					</AlertDialogDescription>
				</AlertDialogHeader>
