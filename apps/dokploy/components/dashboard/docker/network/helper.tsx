...
export const useNetworkDropdownMenuItems = (
  resource: Resource,
  refetchImages: () => void
) => {
  ...
  const deleteNetworkMenuItem = createMenuItem({
    label: "Delete Image",
    loadingLabel: "Deleting...",
    mutationHook: api.docker.deleteNetwork.useMutation,
    successMessage: "Image deleted successfully",
    errorMessage: "Failed to delete image",
  });

  return { deleteNetworkMenuItem };
};
