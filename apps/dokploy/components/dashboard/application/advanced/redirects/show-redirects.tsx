              ...
              {data?.redirects.map((redirect) => (
                <div key={redirect.redirectId}>
                  <div className="flex w-full flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-10 border rounded-lg p-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 flex-col gap-4 sm:gap-8 justify-between w-full">
                      <MountInfoItem label="Regex" value={redirect.regex} />
                      <MountInfoItem
                        label="Replacement"
                      ...
                      <MountInfoItem
                        label="Permanent"
                        value={redirect.permanent ? "Yes" : "No"}
                      />
                    </div>
